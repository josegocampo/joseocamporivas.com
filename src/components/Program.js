    ...
    <Bod className="App" css={colorMode}>
      <Sides className="left-right">
        ...
        >
          ...
          <div className="essay">
            <h1>Titulo</h1>
            dkdsksdkdfskdsf kdfsfdskfsdkdfsk kdfsdfksfdskdsfkfdskfdskfdskfdskdfkfdsk
            sdkfdfdskfdskfdskfdskdfskfds sdkfdskfsdkfdsfkdsfdskfdskdfs sdfkdfskfdsfdskfdsssssssss.{' '}
