    ...
    if (color === 'white'){
      ...
      return (
        ...
        <img src={mejor} className="me2"/>
                            ...
                            dkdsksdkdfskdsf
                            kdfsfdskfsdkdfsk
                            kdfsdfksfdskdsfkfdskfdskfdskfdskdfkfdsk
                            sdkfdfdskfdskfdskfdskdfskfds
                            sdkfdskfsdkfdsfkdsfdskfdskdfs
                            sdfkdfskfdsfdskfdsssssssss. <Link to="/program">Program</Link>
